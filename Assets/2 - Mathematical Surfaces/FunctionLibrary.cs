...
public static class FunctionLibrary
{
	...
	public enum FunctionName { Wave, MultiWave, Ripple, Sphere, Torus2 }
	static Function[] functions = { Wave, MultiWave, Ripple, Sphere, Torus2 };
	//public enum FunctionName { Wave, MultiWave, Ripple, Sphere, Sphere2, Sphere3, Sphere4, Sphere5, Torus, Torus2 }
	//static Function[] functions = { Wave, MultiWave, Ripple, Sphere, Sphere2, Sphere3, Sphere4, Sphere5, Torus, Torus2 };
